@if($record)
    <div class="col-md-6">
        <div class="form-group">
          ...
          <select name="sub_category_id" class="form-control multiple-search " data-placeholder="Select {{$category_type}} category" style="width: 100%;" data-parsley-required="true" >
