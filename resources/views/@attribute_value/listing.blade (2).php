    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            ...
            @can('Attribute-create')
              <a href="{{ url('attribute_value/create') }}" class="btn btn-primary d-lg-block m-l-15" title="{{ __('Add Attribute') }}"  ><i class="fa fa-plus"></i> {{ __('Add Attribute Value') }}</a>
            @endcan
        </div>
    </div>
</div>
...
ajax_datatable = $('#listing').DataTable({
    ...
    rowCallback: function(row, data, iDisplayIndex) {  
      ...
      @if($user_type == 1)
        links += `<a href="{{url('attribute_value/edit')}}/${data.id}" title="Edit Details" class="btn btn-primary btn-xs" ><span class="fa fa-edit"></span></a>`;
...
$(document).on('click','.change_status',function(e){
      ...
      if(response){
        ...
        $.ajax({
          ...
          dataType:'json',
          url: "{!! url('attribute_value/changeStatus' )!!}" + "/" + id +'/'+status,
...
$(document).on('click','.view_btn',function(e){
    ...
    $.ajax({
       url:'{{url('attribute_value/view')}}/'+id,
       dataType: 'html',
       success:function(result)
       {
...
$(document).on('click','.import_btn',function(e){
    ...
    id = $(this).attr('data-product_id');
    $.ajax({
       url:'{{url('attribute_value/import')}}',
       dataType: 'html',
       success:function(result)
       {
...
$("#add_images").on('submit',function(e){ 
  ...
  var _this=$(this); 
    ...
    $.ajax({
    url:'{{ url('attribute_value/add-more-images') }}/'+image_id,
    dataType:'json',
    data:formData,
    type:'POST',
    cache:false,
