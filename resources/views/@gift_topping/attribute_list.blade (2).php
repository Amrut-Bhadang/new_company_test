					...
					<tr class="attributes_values_tr attributes_values_tr_0">
						<?php foreach ($records as $k => $v) { ?>
							<td>
								...
								<select name="attribute[0][attribute_value_lang_id][{{$v->id}}]" id="attribute_value_id" class="form-control select2" data-placeholder="Select Attribute" style="width: 100%;">
						...
						<input type="hidden" name="attribute[0][is_mandatory]" class="is_mandatory_input_{{$v->id}}" value="1">
						<!-- <td>
						...
						<input type="hidden" name="attribute[0][is_free]" class="isFree_input_{{$v->id}}" value="0">
