...
<div class="row page-titles">
  <div class="col-md-5 align-self-center">
    <div class="d-flex align-items-center">
      ...
      <h4 class="text-themecolor">{{ __('backend.Add_court_category') }}</h4>
    </div>
  </div>
  <div class="col-md-7 align-self-center text-right">
    <div class="d-flex justify-content-end align-items-center">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">{{ __('backend.Add_court_category') }}</li>
      </ol>
...
<!-- <div class="row">
  <div class="col-md-6" style="margin-bottom: 10px;">
     <a href="{{ url('admin/court-category') }}" class="btn btn-primary btn-sm" ><i class="fa fa-arrow-left"></i> Back </a>
  </div>
</div> -->
...
<div class="row">
  <div class="container-fluid">
    <form method="POST" action="{{ url('admin/api/court-category') }}" enctype="" id="add_court_category">
      @csrf
      <div class="col-md-12">
              ...
              @if($language)
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="name[{{$lang}}]" data-parsley-required="true" value="" id="name" class="form-control" placeholder=" {{__('backend.Name')}}"  />
                  </div>
                </div>
                @endforeach
                  @endif
...
<script>
  $('.select2').select2();
  $('#add_court_category').parsley();
  $(document).on('submit', "#add_court_category", function(e) {
    e.preventDefault();
    var _this = $(this);
    $('#group_loader').fadeIn();
    ...
    $.ajax({
      ...
      success: function(res) {
        if (res.status === 1) {
          ...
          $('#add_court_category')[0].reset();
          $('#add_court_category').parsley().reset();
          //console.log('helo');
