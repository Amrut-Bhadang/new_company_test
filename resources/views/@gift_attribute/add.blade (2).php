...
<div class="content">
    <div class="row">
        <form method="POST" action="{{ url('api/gift_attribute') }}" id="add_attribute" style="width: 100%">
            @csrf   
            <div class="col-md-12">
                                ...
                                @if($user_type != 4)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="category_id" id="category_id" onchange="getCategory()" class="form-control select3" data-placeholder="Select Category" style="width: 100%;" data-parsley-required="true" >
...
<script type="text/javascript">
    function getCategory() {
        ...
        if (category_id && category_id != '') {
            $.ajax({
               url:'{{url('gift_attribute/show_category')}}/'+category_id,
               dataType: 'html',
