    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            ...
            @can('Attribute-create')
              <a href="{{ url('gift_attribute/create') }}" class="btn btn-primary d-lg-block m-l-15" title="{{ __('Add Attribute') }}"  ><i class="fa fa-plus"></i> {{ __('Add Attribute') }}</a>
        ...
        <div class="card card-primary card-outline">
                ...
                @if($user_type != 4)
  								<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
  									<div class="form-group" style="margin-right:5px">
  										<select name="category_id" id="category_id" onchange="getCategoryByIds()" class="form-control select2" multiple="multiple"  data-placeholder="Select Category" data-dropdown-css-class="select2-primary">
                ...
                @endif
								<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 categoriesOptions">
									<div class="form-group" style="margin-right:5px">
										<select name="sub_category_id" id="sub_category_id" class="form-control select3" multiple="multiple"  data-placeholder="Select Sub-Category" data-dropdown-css-class="select2-primary">
...
ajax_datatable = $('#listing').DataTable({
    ...
    rowCallback: function(row, data, iDisplayIndex) {  
      ...
      @can('Attribute-edit')
      links += `<a href="{{url('gift_attribute/edit')}}/${data.id}" title="Edit Details" class="btn btn-primary btn-xs" ><span class="fa fa-edit"></span></a>`;
      @endcan
...
$(document).on('click','.change_status',function(e){
      ...
      if(response){
        ...
        $.ajax({
          ...
          dataType:'json',
          url: "{!! url('gift_attribute/changeStatus' )!!}" + "/" + id +'/'+status,
...
$(document).on('click','.view_btn',function(e){
    ...
    $.ajax({
       url:'{{url('gift_attribute/view')}}/'+id,
       dataType: 'html',
       success:function(result)
       {
...
$("#add_images").on('submit',function(e){ 
  ...
  var _this=$(this); 
    ...
    $.ajax({
    url:'{{ url('gift_attribute/add-more-images') }}/'+image_id,
    dataType:'json',
    data:formData,
    type:'POST',
    cache:false,
