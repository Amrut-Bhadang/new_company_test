...
<form method="POST" action="{{ url('attribute/importData') }}" id="import_category_data" enctype="multipart/form-data">
    @csrf
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group mt-btn">
               <a href="{{url('public/uploads/Attribute_import_sample.xlsx')}}" class="btn btn-success btn-lg" title="Demo Download"><i class="fas fa-file-excel" aria-hidden="true"></i> Sample File</a>
            </div>
          </div>
        </div>
