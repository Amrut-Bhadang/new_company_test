...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
      <div class="d-flex align-items-center">
          <a href="{{ url('gift_attribute') }}" class="btn btn-primary btn-sm mr-3" ><i class="fa fa-arrow-left"></i> Back </a>
    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('gift_attribute') }}">{{ __('Attribute Manager') }}</a></li>
...
<!-- <div class="row">
    <div class="col-md-6" style="margin-bottom: 10px;">
       <a href="{{ url('gift_attribute') }}" class="btn btn-primary btn-sm" ><i class="fa fa-arrow-left"></i> Back </a>
    </div>
</div> -->
<div class="content">
  <div class="row">
        <form method="POST" action="{{ url('api/gift_attribute/'.$attributes->id) }}" id="edit_attribute" style="width: 100%">
            @csrf   
            <div class="col-md-12">
                    ...
                    <div class="card-body">
                        <div class="tab-content" style="margin-top:10px">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label" for="main_category_id">Category*</label>
                                        <select disabled="" name="main_category_id" id="category_id" class="form-control select3" data-placeholder="Select Category" style="width: 100%;" data-parsley-required="true" >
                                            <option value=''>--Select category--</option>
                                            @foreach ($category as $category)
                                                <option value="{{ $category->id }}" {{ $attributes->category_id == $category->id?'selected':'' }} >{{ $category->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                      ...
                                      @foreach ($attribute_names as $key => $attribute)
                                        <div id="TextBoxDivEdit{{$key+1}}">
                                          ...
                                          if (isset($attribute->id)) {
                                              $langData_en = GiftAttributesLang::where(['id'=>$attribute->id])->first();  
                                          }
                                          ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <a href="{{ url('/gift_attribute') }}" class="btn btn-warning waves-effect waves-light m-r-10" data-dismiss="modal">Close</a>
...
<script type="text/javascript">
    ...
    function getCategory() {
      ...
      var sub_category_id = "<?php echo $attributes->sub_category_id ?>";
      $.ajax({
         url:'{{url('gift_attribute/show_category')}}/'+category_id+'/'+sub_category_id,
         dataType: 'html',
...
$("#edit_attribute").on('submit',function(e){ 
  e.preventDefault();
    ...
    $.ajax({
    url:'{{ url('api/gift_attribute/'.$attributes->id) }}',
    dataType:'json',
    data:formData,
    type:'POST',
    cache:false,
    ...
    success:function(res){
            if(res.status === 1){ 
              ...
              window.location.href = "{{ url('gift_attribute') }}"
