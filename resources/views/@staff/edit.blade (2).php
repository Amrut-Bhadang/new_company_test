...
<form method="PUT" action="{{ url('api/users/'.$users->id) }}" id="edit_role">
    @csrf
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          <label class="control-label" for="first_name">First Name*</label>
          <input type="text" name="first_name" value="{{$users->first_name}}" id="first_name" class="form-control" placeholder="First Name" data-parsley-pattern="^[a-zA-Z]+$" data-parsley-pattern-message="First name allow only character" data-parsley-required="true"  />
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
          <label class="control-label" for="last_name">Last Name*</label>
          <input type="text" name="last_name" value="{{$users->last_name}}" id="last_name" class="form-control" placeholder="Last Name" data-parsley-pattern="^[a-zA-Z]+$" data-parsley-pattern-message="Last name allow only character" data-parsley-required="true"  />
        </div>
      </div>
    </div>
    <div class="row">
