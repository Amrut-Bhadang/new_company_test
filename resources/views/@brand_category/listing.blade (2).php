...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">{{ __('Vendor Category Manager') }}</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/') }}">{{ __('backend.home') }}</a></li>
                <li class="breadcrumb-item active">{{ __('Vendor Category Manager') }}</li>
            </ol>
            @can('Brand-create')
              ...
              <!-- <a href="{{ url('/brand_category/exportUsers/0') }}" class="btn btn-warning d-none d-lg-block m-l-15" title="{{ __('Export') }}"><i class="fa fa-download"></i> {{ __('Export') }}</a> -->
...
<div class="modal fade" id="add_modal">
  <div class="modal-dialog modal-lg">
    ...
    <form method="POST" action="{{ url('api/brand_category') }}" id="add_category">
    @csrf
...
$(document).on('click','.change_status',function(e){
      ...
      if(response){
        ...
        $.ajax({
          ...
          dataType:'json',
          url: "{!! url('brand_category/changeStatus' )!!}" + "/" + id +'/'+status,
...
$(document).on('click','.view_btn',function(e){
    ...
    $.ajax({
       url:'{{url('brand_category/view')}}/'+id,
       dataType: 'html',
...
$(document).on('click','.edit_category',function(e){
    ...
    id = $(this).attr('data-category_id');
    $.ajax({
       url:'{{url('brand_category/edit')}}/'+id,
       dataType: 'html',
       success:function(result)
       {
