...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
      <div class="d-flex align-items-center">
        ...
        <h4 class="text-themecolor">{{ __('Rating List') }}</h4>
      </div>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{ __('Rating List') }}</li>
            </ol>
        </div>
    </div>
</div>
                ...
                <div class="card-body">
                    ...
                    <table id="restaurant_listing" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                              <td><img width="100" height="100" src="{{ $value->image ? url('uploads/user').'/'.$value->image : url('images/no-image-available.png') }}"></td>
                              <td>{{ $value->name}}</td>
