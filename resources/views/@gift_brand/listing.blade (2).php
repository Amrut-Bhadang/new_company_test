...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">{{ __('Brand Manager') }}</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            ...
            @can('Gift-Brand-section')
              <a href="#" class="btn btn-primary d-none d-lg-block m-l-15" title="{{ __('Add Brand') }}" data-toggle="modal" data-target="#add_modal" ><i class="fa fa-plus"></i> {{ __('Add Brand') }}</a>
...
<div class="modal fade" id="add_modal">
  <div class="modal-dialog modal-lg">
    ...
    <form method="POST" action="{{ url('api/gift_brand') }}" id="add_brand">
    @csrf
...
ajax_datatable = $('#brand_listing').DataTable({
    ...
    rowCallback: function(row, data, iDisplayIndex) {  
      ...
      links += `<a href="{{url('gift_brand/brand_gift')}}/${data.id}" title="View Gifts" class="btn btn-warning btn-xs" ><span class="fas fa-gift"></span></a>`;
      @endcan
