        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              <label class="col-md-12" for="restaurant_id">Restaurant Name</label>
              <select name="restaurant_id" class="form-control select3" style="width: 100%;" data-parsley-required="true">
          ...
          <!-- <div class="col-md-6">
            <div class="form-group">
              <label class="col-md-6" for="category_id">Category Name</label>
