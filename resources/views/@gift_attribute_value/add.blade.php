    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('gift_attribute_value') }}">{{ __('Attribute Value Manager') }}</a></li>
...
<div class="content">
    <div class="row">
        <form method="POST" action="{{ url('api/gift_attribute_value') }}" id="add_attribute" style="width: 100%">
            @csrf   
            <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="category_id" id="category_id" onchange="getCategory()" class="form-control select3" data-placeholder="Select Service" style="width: 100%;" data-parsley-required="true" >
...
<script type="text/javascript">
    ...
    function getCategory() {
        ...
        $.ajax({
           url:'{{url('gift_attribute_value/show_category')}}/'+category_id,
           dataType: 'html',
    ...
    function getAttributes() {
        ...
        $.ajax({
           url:'{{url('gift_attribute_value/show_attributes')}}/'+category_id+'/'+sub_category_id,
           dataType: 'html',
           success:function(result)
           {
