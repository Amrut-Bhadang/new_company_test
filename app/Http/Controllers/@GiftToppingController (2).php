...
class GiftToppingController extends Controller
{
    ...
    public function frontend()
    {
        ...
        return view('gift_topping.listing',$data);
    }
    ...
    public function show_category($main_category_id, $category_id='') {
      ...
      return view('gift_topping.category',$data);
    ...
    public function show_category_popup($main_category_id, $category_id='') {
      ...
      $data['category_id'] = $category_id;
      return view('gift_topping.category_popup',$data);

    }

    public function show_attributes($category_id, $sub_category_id, $dish_id = '') {

      if ($category_id) {
        $data['records'] = GiftAttributesLang::select('attributes_lang.name','attributes_lang.id')->join('attributes','attributes.id','=','attributes_lang.attribute_id')->where(['attributes.category_id'=>$category_id, 'attributes.sub_category_id'=>$sub_category_id])->get();
        $data['category_id'] = $category_id;
        $data['sub_category_id'] = $category_id;

        foreach ($data['records'] as $key => $value) {
          $value->attribute_values = GiftAttributeValueLang::select('attribute_value_lang.name','attribute_value_lang.id')->join('attribute_values','attribute_values.id','=','attribute_value_lang.attribute_value_id')->where('attribute_values.attributes_lang_id', $value->id)->get();
        }
      ...
      if ($dish_id) {
        $data['product_attributes'] = GiftProductAttributes::select('gift_attributes.*')->where(['gift_id' => $dish_id])->get();

        if ($data['product_attributes']) {

          foreach ($data['product_attributes'] as $k => $v) {
            $v->selected_attr_values = GiftProductAttributeValues::where(['gift_attributes_id' => $v->id])->pluck('attribute_value_lang_id')->toArray();
          }
        }
      } else {
      ...
      if ($dish_id) {
        return view('gift_topping.attribute_edit_list',$data);

      } else {
        return view('gift_topping.attribute_list',$data);
      }

    }

    public function show_single_attributes($category_id, $sub_category_id, $option_type, $gift_id = '') {
      ...
      if ($category_id) {
        ...
        foreach ($data['records'] as $key => $value) {
          $attribute_values = GiftAttributeValueLang::select('attribute_value_lang.name','attribute_value_lang.id')->join('attribute_values','attribute_values.id','=','attribute_value_lang.attribute_value_id')->where('attribute_values.attributes_lang_id', $value->id);
          ...
          if ($gift_id) {
            ...
            foreach ($value->attribute_values as $k => $v) {
              $value->product_attributes = GiftProductAttributes::select('gift_attributes.*')->join('gift_attribute_values', 'gift_attribute_values.gift_attributes_id', 'gift_attributes.id')->where(['gift_id' => $gift_id])->where('gift_attribute_values.attributes_lang_id', $value->id)->get();

              if ($value->product_attributes && isset($value->product_attributes[0])) {

                foreach ($value->product_attributes as $k_1 => $v_1) {
                  $v_1->selected_attr_values = GiftProductAttributeValues::where(['gift_attributes_id' => $v_1->id])->pluck('attribute_value_lang_id')->toArray();
                }
                ...
                foreach ($value->product_attributes as $k_2 => $v_2) {
                  $v_2->selected_attr_values = GiftProductAttributeValues::where(['gift_attributes_id' => $v_2['id']])->pluck('attribute_value_lang_id')->toArray();
                }
              }
            }
          }
      ...
      if ($gift_id) {
        $data['product_attributes'] = GiftProductAttributes::select('gift_attributes.*')->where(['gift_id' => $gift_id])->get();
      ...
      if ($gift_id) {
        ...
        if ($option_type != 'single') {
          ...
          return view('gift_topping.single_attribute_edit_list',$data);
        }

      } else {
        return view('gift_topping.single_attribute_list',$data);
      }

    }

    public function show_attribute_values($category_id, $sub_category_id, $count, $customizeType='') {

      if ($category_id) {

        if ($customizeType) {
          $data['records'] = GiftAttributesLang::select('attributes_lang.name','attributes_lang.id')->join('attributes','attributes.id','=','attributes_lang.attribute_id')->where('attributes.category_id', $category_id)->where('attributes.sub_category_id', $sub_category_id)->where('attributes_lang.id', $customizeType)->get();

        } else {
          $data['records'] = GiftAttributesLang::select('attributes_lang.name','attributes_lang.id')->join('attributes','attributes.id','=','attributes_lang.attribute_id')->where('attributes.category_id', $category_id)->where('attributes.sub_category_id', $sub_category_id)->get();
        }
        $data['category_id'] = $category_id;
      ...
      if ($customizeType) {
        return view('gift_topping.single_attribute_value_td',$data);

      } else {
        return view('gift_topping.attribute_value_td',$data);
      }
    ...
    public function show_dishes($category_id, $dish_id = '') {
      ...
      return view('gift_topping.dish_list',$data);
    ...
    public function show_category_byIds($main_category_id) {
        ...
        return view('gift_topping.filtered_category',$data);
    }
    ...
    public function show_productsByMainCatIds($category_id) {
      ...
      return view('gift_topping.dish_filter_list',$data);
    ...
    public function edit_frontend($id)
    {
        ...
        $data['category']=Topping::select('*')
                ...
                ->first();
        $data['main_category']=MainCategory::select('name','id')->where(['status'=>1])->get();
        $data['product_attributes'] = GiftProductAttributes::select('product_attributes.*')->where(['product_id' => $data['category']->dish_id])->count();
        return view('gift_topping.edit',$data);
    }
    /**
    ...
    public function create()
    {
        ...
        $data['topping_category'] = ToppingCategory::all();
        return view('gift_topping.add',$data);
    }
    ...
    public function show($id)
    {
        ...
        return view('gift_topping.view',$data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if(!$fail) {
          ...
          try{
              ...
              GiftProductAttributes::where('product_id',$input['dish_id'])->delete();
    ...
    public function import(){
        $data['main_category']=MainCategory::select('name','id')->where(['status'=>1])->get();
        return view('gift_topping.import',$data);
    }
}
